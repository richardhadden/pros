...
from .properties import AliasProperty, DateTimeProperty
...
def process_filter_args(cls, kwargs):
    ...
    for key, value in kwargs.items():
        ...
        # ic(output, db_property, operator, deflated_value)
            ...
            if isinstance(child, QBase):
                ...
                for prop, op_and_val in filters.items():
                    ...
                    if op in _UNARY_OPERATORS:
                        ...
                        # If the type is a datetime, explicitly wrap in the cypher datetime()
                        # function within the query.
                        if isinstance(val, datetime.datetime):
                            statement = "{0}.{1} {2} datetime(${3})".format(
